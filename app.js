...
// const userName = prompt("Please enter your name:") || "Dear";
// name.textContent = `Hi ${userName} , create your list...`;
...
form.addEventListener("submit", (e) => {
  ...
  task_completed_button.addEventListener("click", () => {
    ...
    task_input.setAttribute("readonly", "readonly");
    console.log(task_input.style);
  });
  
  
  task_completed_button.addEventListener('dblclick', () => {
    task_input.style.textDecoration = 'none';
